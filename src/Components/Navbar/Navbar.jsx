                ...
                <nav className='flex items-center py-2 justify-between'>
                    <div className='flex gap-12 items-center'>
                        ...
                        <div className=' relative'>
                            ...
                            <input type="text" placeholder='Search' className='rounded-2xl py-3 pl-12 bg-slate-200 w-[300px] focus:outline-none' />
                        </div>
                    </div>
                    <div className='flex gap-6 items-center'>
                        ...
                        <div className='flex items-center gap-4 cursor-pointer' onClick={handleShowButton}>
                            <img src={user} alt="" className='rounded-full w-9 h-9 object-cover' />
                            <p>Jakob Botosh</p>
                            <motion.div
                                initial={{ rotate: 0 }}
